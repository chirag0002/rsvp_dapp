...
export class Event extends Entity {
  ...
  get rsvps(): RSVPLoader {
    return new RSVPLoader("Event", this.get("id")!.toString(), "rsvps");
  }

  get confirmedAttendees(): ConfirmationLoader {
...
export class Account extends Entity {
  ...
  get rsvps(): RSVPLoader {
    return new RSVPLoader("Account", this.get("id")!.toString(), "rsvps");
  }

  get attendedEvents(): ConfirmationLoader {
    return new ConfirmationLoader(
      "Account",
      this.get("id")!.toString(),
      "attendedEvents"
...
export class RSVPLoader extends Entity {
  _entity: string;
  _field: string;
  _id: string;
